...
class _SignInScreenState extends State<SignInScreen> {
  ...
  String? _generalError; // To hold the general error message
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          final Map<String, dynamic> responseData = jsonDecode(response.body);
          setState(() {
            _generalError = responseData['message'] ?? 'Invalid email or password.';
          });
        } else {
          // Unexpected error
          setState(() {
            _generalError = 'Unexpected error occurred. Please try again later.';
          });
        }
      } catch (e) {
